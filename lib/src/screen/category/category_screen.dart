        ...
        child: SizedBox(
          ...
          child: Row(
            children: [
              ...
              //
              if (_catController.featuredIndex.value)
                Expanded(
                  flex: 2,
                  child: Container(
                    height: size.height,
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(
                          child: FutureBuilder<List<CategoryProductData>>(
                            future: _catController.getProductByCategory(
                              _catController
                                  .categoryList[_catController.index.value].id!,
                            ),
